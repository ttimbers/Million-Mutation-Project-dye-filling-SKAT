...
# udocker run --rm ttimbers/mmp-dyf-skat bash /home/ttimbers/projects/Million-Mutation-Project-dye-filling-SKAT/make_clean_with_udocker.sh /home/ttimbers/projects/Million-Mutation-Project-dye-filling-SKAT
#
# Example of how I ran it on my local machine:
# docker run --rm -v /Users/tiffanytimbers/Documents/Post-Doc/Manuscripts/MMP_dyf_screen/code/Million-Mutation-Project-dye-filling-SKAT:/home/Million-Mutation-Project-dye-filling-SKAT ttimbers/mmp-dyf-skat bash /home/Million-Mutation-Project-dye-filling-SKAT/make_clean_with_udocker.sh /home/Million-Mutation-Project-dye-filling-SKAT
