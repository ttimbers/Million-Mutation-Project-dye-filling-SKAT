...
main <- function() {
  ...
  ## save SSID file
  write.table(SSID_count_greater_or_equal_to_min, file = SNP_location_output_file, row.names = FALSE, col.names = FALSE, quote = FALSE)
  ...
  ## save .vcf file
  write.table(vcf_count_greater_or_equal_to_min, file = vcf_output_file, row.names = FALSE, col.names = FALSE, quote = FALSE)
