...
#data/amphid_dyf/SKAT_no_weights_results.txt data/amphid_dyf/SKAT_weights_results.txt:
#	Rscript bin/do_SKAT.R data/amphid_dyf/filteredMMP.fam phenotype_amphid_dyf_dichotomous.csv data/filteredMMP_noHeader.vcf  data/MMP_non-syn_coding_SSID.txt data/amphid_dyf data/MMP_SNP_WeightFile.txt
